...
class VisitServiceUnitTest {
    ...
    void createVisit_valid_savesAndReturnsAgentVisitDTOWithPendingStatus() {
        ...
        when(visitRepository.findAgentVisitById(5L)).thenReturn(Optional.of(new AgentVisitDTO(saved, null, null)));
    ...
    void updateVisitStatus_confirmPending_shouldSetConfirmedAndCallValidator() {
        ...
        when(visitRepository.findAgentVisitById(10L)).thenReturn(Optional.of(new AgentVisitDTO(visit, null, null)));
